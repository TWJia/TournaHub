...
const cek = async (email,username) =>{
    
    let qry = `select count(*) as count from user where email = ? or username = ?`
    let result = await dbase.executeQueryWithParam(qry,[email,username])

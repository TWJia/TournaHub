...
function SponsorshipModels() {
  ...
  const handleCheckoutIcon = async () => {
    try {
      const response = await axios.post(
        "http://localhost:3001/create-checkout-session-icon"
      );
  ...
  const handleCheckoutTournament = async () => {
    try {
      const response = await axios.post(
        "http://localhost:3001/create-checkout-session-tournament"
      );
  ...
  const handleCheckoutArticle = async () => {
    try {
      const response = await axios.post(
        "http://localhost:3001/create-checkout-session-article"
      );

...
function ViewTournament() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        if (user) {
          const response = await axios.get(
            `http://localhost:3001/getTournaments/${user._id}?sortBy=tournamentStartDate`
          );
  ...
  const handleSearch = async (searchTerm) => {
    ...
    if (searchTerm.trim() === "") {
      ...
      try {
        const response = await axios.get(
          `http://localhost:3001/searchTournaments/${searchTerm}/${user._id}`
        );
                  ...
                  .map((tournament) => (
                    ...
                    >
                      ...
                      <td style={{ padding: "10px" }}>
                        ...
                        <button
                          onClick={() =>
                            handleNavigateToAddStatistics(tournament._id)
                          }
                          className="btn btn-sm btn-success mr-2"
                        >
                          Add Statistics
                        ...
                        <button
                          onClick={() =>
                            handleNavigateToUpdateStatistics(tournament._id)
                          }
                          className="btn btn-sm btn-warning mr-2"
                        >
                          Edit Statistics
